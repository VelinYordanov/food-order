...
public class ValidationConstraints {
    ...
    public static final String EMAIL_OUT_OF_BOUNDS =
	    "Email must be between " + MIN_LENGTH_EMAIL + " and " + MAX_LENGTH_EMAIL + " symbols.";
    ...
    public static final String NAME_OUT_OF_BOUNDS =
	    "Name must be between " + MIN_LENGTH_EMAIL + " and " + MAX_LENGTH_EMAIL + " symbols.";
    ...
    public static final String FOOD_NAME_OUT_OF_BOUNDS =
	    "Name must be between " + MIN_LENGTH_FOOD_NAME + " and " + MAX_LENGTH_FOOD_NAME + " symbols.";
    ...
    public static final String CATEGORY_NAME_OUT_OF_BOUNDS =
	    "Name must be between " + MIN_LENGTH_CATEGORY_NAME + " and " + MAX_LENGTH_CATEGORY_NAME + " symbols.";
    ...
    public static final String NEIGHBORHOOD_OUT_OF_BOUNDS =
	    "Neighborhood must be between " + MIN_LENGTH_NEIGHBORHOOD + " and " + MAX_LENGTH_NEIGHBORHOOD + " symbols.";
    ...
    public static final String STREET_OUT_OF_BOUNDS =
	    "Street must be between " + MIN_LENGTH_STREET + " and " + MAX_LENGTH_STREET + " symbols.";
    ...
    public static final String STREET_NUMBER_OUT_OF_BOUNDS =
	    "Street number must be between " + MIN_LENGTH_STREET_NUMBER
		    + " and "
    ...
    public static final String APARTMENT_BUILDING_NUMBER_OUT_OF_BOUNDS =
	    "Apartment building number must be between " + MIN_LENGTH_APARTMENT_BUILDING_NUMBER
		    + " and "
		    + MAX_LENGTH_APARTMENT_BUILDING_NUMBER
		    + " symbols.";
    ...
    public static final String ENTRANCE_OUT_OF_BOUNDS =
	    "Apartment building number must be between " + MIN_LENGTH_ENTRANCE
		    + " and "
		    + MAX_LENGTH_ENTRANCE
		    + " symbols.";
    ...
    public static final String APARTMENT_NUMBER_OUT_OF_BOUNDS =
	    "Apartment number must be between " + MIN_LENGTH_APARTMENT_NUMBER
		    + " and "
		    + MAX_LENGTH_APARTMENT_NUMBER
		    + " symbols.";
